...
int xum1541_read_cb(struct opencbm_usb_handle *HandleXum1541, unsigned char mode,
    unsigned char *data, size_t size, cbm_tap_capture_callback_t ReadCallback);    
...
int xum1541_read_ext_cb(struct opencbm_usb_handle *HandleXum1541, unsigned char mode,
    unsigned char *data, size_t size, int *Status, int *BytesRead, cbm_tap_capture_callback_t ReadCallback);
